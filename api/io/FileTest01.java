...
public class FileTest01 {
	public static void main(String[] args) {
		//액세스하고싶은파일이나 폴더의위치를 file객체 만들 때 매개변수에 정의
		//1. c:\iot\iotest폴더
		File file1 = new File("c:/iot/iotest"); // '\'만 쓰면 오류나서 '\\'로 써주면 된다.
		// 또는역슬래시 2개말고 그냥 슬래시 해도 된다.
		...
		System.out.println("file3.getAbolutPath()=>" +file3.getAbsolutePath());
